...
Option::Option(optionType option_type, vector<double> option_input) : option_type(option_type), expiry(option_input[0]), strike(option_input[1]), sig(option_input[2]), rf_rate(option_input[3]), asset_price(option_input[4]) { }
